...
_qt5_3DRender_process_prl_file(
    "${_qt53DRender_install_prefix}/plugins/sceneparsers/gltfsceneexport.prl" RELEASE
...
_populate_3DRender_plugin_properties(GLTFSceneExportPlugin RELEASE "sceneparsers/gltfsceneexport.lib" FALSE)
...
string(CONCAT _plugin_genex
    "$<$<OR:"
        ...
        "$<AND:"
            ...
            "$<OR:"
                "$<STREQUAL:$<TARGET_PROPERTY:Qt5::GLTFSceneExportPlugin,QT_PLUGIN_EXTENDS>,Qt5::3DRender>,"
