...
set(_Qt5QWindowsDirect2DIntegrationPlugin_MODULE_DEPENDENCIES "EventDispatcherSupport;FontDatabaseSupport;ThemeSupport;Gui;Gui;Core;Core")

foreach(_module_dep ${_Qt5QWindowsDirect2DIntegrationPlugin_MODULE_DEPENDENCIES})
...
_qt5_Gui_process_prl_file(
    "${_qt5Gui_install_prefix}/plugins/platforms/qdirect2d.prl" RELEASE
    _Qt5QWindowsDirect2DIntegrationPlugin_STATIC_RELEASE_LIB_DEPENDENCIES
    _Qt5QWindowsDirect2DIntegrationPlugin_STATIC_RELEASE_LINK_FLAGS
)


set_property(TARGET Qt5::QWindowsDirect2DIntegrationPlugin PROPERTY INTERFACE_SOURCES
...
set(_user_specified_genex
    "$<IN_LIST:Qt5::QWindowsDirect2DIntegrationPlugin,${_manual_plugins_genex};${_plugin_type_genex}>"
)
string(CONCAT _plugin_genex
    "$<$<OR:"
        ...
        "$<AND:"
            ...
            "$<OR:"
                "$<STREQUAL:$<TARGET_PROPERTY:Qt5::QWindowsDirect2DIntegrationPlugin,QT_PLUGIN_EXTENDS>,Qt5::Gui>,"
                "$<STREQUAL:$<TARGET_PROPERTY:Qt5::QWindowsDirect2DIntegrationPlugin,QT_PLUGIN_EXTENDS>,>"
            ">,"
            "$<NOT:$<IN_LIST:Qt5::QWindowsDirect2DIntegrationPlugin,${_no_plugins_genex}>>"
        ">"
    ">:Qt5::QWindowsDirect2DIntegrationPlugin>"
)
set_property(TARGET Qt5::Gui APPEND PROPERTY INTERFACE_LINK_LIBRARIES
    ${_plugin_genex}
)
set_property(TARGET Qt5::QWindowsDirect2DIntegrationPlugin APPEND PROPERTY INTERFACE_LINK_LIBRARIES
