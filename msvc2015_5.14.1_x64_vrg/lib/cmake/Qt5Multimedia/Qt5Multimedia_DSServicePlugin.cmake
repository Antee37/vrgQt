...
_qt5_Multimedia_process_prl_file(
    "${_qt5Multimedia_install_prefix}/plugins/mediaservice/dsengine.prl" RELEASE
    _Qt5DSServicePlugin_STATIC_RELEASE_LIB_DEPENDENCIES
    _Qt5DSServicePlugin_STATIC_RELEASE_LINK_FLAGS
)


set_property(TARGET Qt5::DSServicePlugin PROPERTY INTERFACE_SOURCES
...
set(_user_specified_genex
    "$<IN_LIST:Qt5::DSServicePlugin,${_manual_plugins_genex};${_plugin_type_genex}>"
)
string(CONCAT _plugin_genex
    "$<$<OR:"
        ...
        "$<AND:"
            ...
            "$<OR:"
                "$<STREQUAL:$<TARGET_PROPERTY:Qt5::DSServicePlugin,QT_PLUGIN_EXTENDS>,Qt5::Multimedia>,"
                "$<STREQUAL:$<TARGET_PROPERTY:Qt5::DSServicePlugin,QT_PLUGIN_EXTENDS>,>"
            ">,"
            "$<NOT:$<IN_LIST:Qt5::DSServicePlugin,${_no_plugins_genex}>>"
        ">"
    ">:Qt5::DSServicePlugin>"
)
...
set_property(TARGET Qt5::DSServicePlugin APPEND PROPERTY INTERFACE_LINK_LIBRARIES
    "Qt5::Multimedia;Qt5::Gui;Qt5::Widgets;Qt5::Gui;Qt5::Core;Qt5::Core"
)
