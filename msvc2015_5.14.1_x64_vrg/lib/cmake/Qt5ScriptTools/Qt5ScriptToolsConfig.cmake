...
set(Qt5ScriptTools_VERSION_STRING 5.14.1)
...
if (NOT TARGET Qt5::ScriptTools)
    ...
    set(Qt5ScriptTools_PRIVATE_INCLUDE_DIRS
        "${_qt5ScriptTools_install_prefix}/include/QtScriptTools/5.14.1"
        "${_qt5ScriptTools_install_prefix}/include/QtScriptTools/5.14.1/QtScriptTools"
    )
    ...
    foreach(_module_dep ${_Qt5ScriptTools_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                5.14.1 ${_Qt5ScriptTools_FIND_VERSION_EXACT}
    ...
    _populate_ScriptTools_target_properties(RELEASE "Qt5ScriptTools.lib" "" FALSE)

    if (EXISTS "${_qt5ScriptTools_install_prefix}/lib/Qt5ScriptToolsd.lib" )
        _populate_ScriptTools_target_properties(DEBUG "Qt5ScriptToolsd.lib" "" FALSE)
    endif()
