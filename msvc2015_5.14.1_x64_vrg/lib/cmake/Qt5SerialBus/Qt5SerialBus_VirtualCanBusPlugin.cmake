...
_qt5_SerialBus_process_prl_file(
    "${_qt5SerialBus_install_prefix}/plugins/canbus/qtvirtualcanbus.prl" RELEASE
...
_populate_SerialBus_plugin_properties(VirtualCanBusPlugin RELEASE "canbus/qtvirtualcanbus.lib" FALSE)
...
string(CONCAT _plugin_genex
    "$<$<OR:"
        ...
        "$<AND:"
            ...
            "$<OR:"
                "$<STREQUAL:$<TARGET_PROPERTY:Qt5::VirtualCanBusPlugin,QT_PLUGIN_EXTENDS>,Qt5::SerialBus>,"
