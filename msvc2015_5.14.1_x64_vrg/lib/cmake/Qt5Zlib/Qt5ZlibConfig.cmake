        ...
        foreach(_flag ${_static_depends})
            ...
            elseif(_framework_flag OR _flag MATCHES "^-l(.*)$")
                ...
                elseif(_lib MATCHES "^pthread$")
                    ...
                    find_library(_Qt5Zlib_${Configuration}_${_lib}_PATH ${_lib})
...
if (NOT TARGET Qt5::Zlib)
    ...
    if(NOT Qt5_EXCLUDE_STATIC_DEPENDENCIES)
        ...
        _qt5_Zlib_process_prl_file(
            "${_qt5Zlib_install_prefix}/lib/Qt5Zlib.prl" RELEASE
            _Qt5Zlib_STATIC_RELEASE_LIB_DEPENDENCIES
            _Qt5Zlib_STATIC_RELEASE_LINK_FLAGS
        )
    endif()

    add_library(Qt5::Zlib STATIC IMPORTED)
    set_property(TARGET Qt5::Zlib PROPERTY IMPORTED_LINK_INTERFACE_LANGUAGES CXX)
