...
set(Qt5Script_VERSION_STRING 5.14.1)
...
if (NOT TARGET Qt5::Script)
    ...
    set(Qt5Script_PRIVATE_INCLUDE_DIRS
        "${_qt5Script_install_prefix}/include/QtScript/5.14.1"
        "${_qt5Script_install_prefix}/include/QtScript/5.14.1/QtScript"
    )
    ...
    foreach(_module_dep ${_Qt5Script_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                5.14.1 ${_Qt5Script_FIND_VERSION_EXACT}
    ...
    _populate_Script_target_properties(RELEASE "Qt5Script.lib" "" FALSE)

    if (EXISTS "${_qt5Script_install_prefix}/lib/Qt5Scriptd.lib" )
        _populate_Script_target_properties(DEBUG "Qt5Scriptd.lib" "" FALSE)
    endif()
