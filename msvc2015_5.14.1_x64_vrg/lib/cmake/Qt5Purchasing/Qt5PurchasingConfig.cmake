...
set(Qt5Purchasing_VERSION_STRING 5.14.1)
...
if (NOT TARGET Qt5::Purchasing)
    ...
    set(Qt5Purchasing_PRIVATE_INCLUDE_DIRS
        "${_qt5Purchasing_install_prefix}/include/QtPurchasing/5.14.1"
        "${_qt5Purchasing_install_prefix}/include/QtPurchasing/5.14.1/QtPurchasing"
    )
    ...
    foreach(_module_dep ${_Qt5Purchasing_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                5.14.1 ${_Qt5Purchasing_FIND_VERSION_EXACT}
    ...
    _populate_Purchasing_target_properties(RELEASE "Qt5Purchasing.lib" "" FALSE)

    if (EXISTS "${_qt5Purchasing_install_prefix}/lib/Qt5Purchasingd.lib" )
        _populate_Purchasing_target_properties(DEBUG "Qt5Purchasingd.lib" "" FALSE)
    endif()
