...
set(_Qt5QODBCDriverPlugin_MODULE_DEPENDENCIES "Sql;Core;Core")

foreach(_module_dep ${_Qt5QODBCDriverPlugin_MODULE_DEPENDENCIES})
...
_qt5_Sql_process_prl_file(
    "${_qt5Sql_install_prefix}/plugins/sqldrivers/qsqlodbc.prl" RELEASE
    _Qt5QODBCDriverPlugin_STATIC_RELEASE_LIB_DEPENDENCIES
    _Qt5QODBCDriverPlugin_STATIC_RELEASE_LINK_FLAGS
)


set_property(TARGET Qt5::QODBCDriverPlugin PROPERTY INTERFACE_SOURCES
...
set(_user_specified_genex
    "$<IN_LIST:Qt5::QODBCDriverPlugin,${_manual_plugins_genex};${_plugin_type_genex}>"
)
string(CONCAT _plugin_genex
    "$<$<OR:"
        ...
        "$<AND:"
            ...
            "$<OR:"
                "$<STREQUAL:$<TARGET_PROPERTY:Qt5::QODBCDriverPlugin,QT_PLUGIN_EXTENDS>,Qt5::Sql>,"
                "$<STREQUAL:$<TARGET_PROPERTY:Qt5::QODBCDriverPlugin,QT_PLUGIN_EXTENDS>,>"
            ">,"
            "$<NOT:$<IN_LIST:Qt5::QODBCDriverPlugin,${_no_plugins_genex}>>"
        ">"
    ">:Qt5::QODBCDriverPlugin>"
)
set_property(TARGET Qt5::Sql APPEND PROPERTY INTERFACE_LINK_LIBRARIES
    ${_plugin_genex}
)
set_property(TARGET Qt5::QODBCDriverPlugin APPEND PROPERTY INTERFACE_LINK_LIBRARIES
