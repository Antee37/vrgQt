...
function(_qt5_WinExtras_process_prl_file prl_file_location Configuration lib_deps link_flags)
    ...
    set(_qt5_install_libs "${_qt5WinExtras_install_prefix}/lib/")
            ...
            elseif(_framework_flag OR _flag MATCHES "^-l(.*)$")
                ...
                elseif(_lib MATCHES "^pthread$")
                    ...
                    if(current_search_paths)
                        find_library(_Qt5WinExtras_${Configuration}_${_lib}_PATH ${_lib} HINTS ${current_search_paths} NO_DEFAULT_PATH)
                    endif()
...
macro(_populate_WinExtras_target_properties Configuration LIB_LOCATION IMPLIB_LOCATION
    ...
    set(_static_link_flags "${_Qt5WinExtras_STATIC_${Configuration}_LINK_FLAGS}")
    if(_static_link_flags)
        set(_static_link_flags_genex "$<${_genex_condition}:${_static_link_flags}>")
        if(NOT CMAKE_VERSION VERSION_LESS "3.13")
            set_property(TARGET Qt5::WinExtras APPEND PROPERTY INTERFACE_LINK_OPTIONS
...
if (NOT TARGET Qt5::WinExtras)
    ...
    _populate_WinExtras_target_properties(RELEASE "Qt5WinExtras.lib" "" FALSE)

    if (EXISTS "${_qt5WinExtras_install_prefix}/lib/Qt5WinExtrasd.lib" )
        _populate_WinExtras_target_properties(DEBUG "Qt5WinExtrasd.lib" "" FALSE)
    endif()
