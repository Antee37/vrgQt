...
set(Qt5DataVisualization_VERSION_STRING 5.14.1)
...
function(_qt5_DataVisualization_process_prl_file prl_file_location Configuration lib_deps link_flags)
    ...
    set(_qt5_install_libs "${_qt5DataVisualization_install_prefix}/lib/")
            ...
            elseif(_framework_flag OR _flag MATCHES "^-l(.*)$")
                ...
                elseif(_lib MATCHES "^pthread$")
                    ...
                    if(current_search_paths)
                        find_library(_Qt5DataVisualization_${Configuration}_${_lib}_PATH ${_lib} HINTS ${current_search_paths} NO_DEFAULT_PATH)
                    endif()
...
macro(_populate_DataVisualization_target_properties Configuration LIB_LOCATION IMPLIB_LOCATION
    ...
    set(_static_link_flags "${_Qt5DataVisualization_STATIC_${Configuration}_LINK_FLAGS}")
    if(_static_link_flags)
        set(_static_link_flags_genex "$<${_genex_condition}:${_static_link_flags}>")
        if(NOT CMAKE_VERSION VERSION_LESS "3.13")
            set_property(TARGET Qt5::DataVisualization APPEND PROPERTY INTERFACE_LINK_OPTIONS
...
if (NOT TARGET Qt5::DataVisualization)
    ...
    set(Qt5DataVisualization_PRIVATE_INCLUDE_DIRS
        "${_qt5DataVisualization_install_prefix}/include/QtDataVisualization/5.14.1"
        "${_qt5DataVisualization_install_prefix}/include/QtDataVisualization/5.14.1/QtDataVisualization"
    )
    ...
    foreach(_module_dep ${_Qt5DataVisualization_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                5.14.1 ${_Qt5DataVisualization_FIND_VERSION_EXACT}
    ...
    _populate_DataVisualization_target_properties(RELEASE "Qt5DataVisualization.lib" "" FALSE)

    if (EXISTS "${_qt5DataVisualization_install_prefix}/lib/Qt5DataVisualizationd.lib" )
        _populate_DataVisualization_target_properties(DEBUG "Qt5DataVisualizationd.lib" "" FALSE)
    endif()
